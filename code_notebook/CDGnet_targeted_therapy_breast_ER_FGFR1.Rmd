...
ls()
```
The example_CDGnet_database_inputs.RData file has the drugs_PO_FDA_biomarkers, drugs_PO_FDA_targets, FDA_approved_drugs, and DrugBank_targets objects. To obtain the
KEGG_oncogenes and list_paths_KEGG objects, see the files in the code_process_KEGG directory.
